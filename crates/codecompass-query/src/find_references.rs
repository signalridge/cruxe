...
use codecompass_core::types::{SourceLayer, SymbolRecord};
use codecompass_state::{project, symbols, tombstones};
...
mod tests {
    use super::*;
    use codecompass_core::types::{SymbolEdge, SymbolKind};
    use codecompass_state::{db, edges, schema, symbols};

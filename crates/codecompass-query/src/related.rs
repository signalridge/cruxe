...
use codecompass_indexer::import_extract::source_symbol_id_for_path;
use codecompass_state::{edges, symbols};
...
fn to_related_symbol(
    symbol: codecompass_core::types::SymbolRecord,
    relation: &str,
) -> RelatedSymbol {
    RelatedSymbol {
...
mod tests {
    use super::*;
    use codecompass_core::types::{SymbolEdge, SymbolKind, SymbolRecord};

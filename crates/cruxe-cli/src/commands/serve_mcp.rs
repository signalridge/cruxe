...
use cruxe_core::types::WorkspaceConfig;
use std::path::Path;
...
pub fn run(
    ...
    cruxe_mcp::server::run_server(&workspace, config_file, no_prewarm, workspace_config)
...
pub fn run_http(
    ...
    rt.block_on(cruxe_mcp::http::run_http_server(
        &workspace,
        config_file,
        no_prewarm,
        workspace_config,

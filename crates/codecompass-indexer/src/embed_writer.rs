...
use codecompass_core::types::{SnippetRecord, SymbolRecord};
use codecompass_state::embedding::{self, EmbeddingProvider};
...
impl EmbeddingWriter {
    ...
    pub fn delete_for_file_vectors(
        ...
        let symbol_stable_ids: Vec<String> = codecompass_state::symbols::list_symbols_in_file(
            conn,
            &self.project_id,
            &self.ref_name,
            path,
...
mod tests {
    ...
    use codecompass_core::types::{SnippetRecord, SymbolKind, SymbolRecord};

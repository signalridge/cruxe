...
echo "Running CodeCompass benchmark harness (transport + semantic benchmark lanes)..."
...
cargo test -p codecompass benchmark_t359_call_edge_extraction_overhead_under_20_percent -- --ignored --nocapture

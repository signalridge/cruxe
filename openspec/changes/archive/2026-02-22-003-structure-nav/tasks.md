## 1. Foundation (Edge Storage + Token Estimation)
...
## 2. Import Extraction (Per-Language Parsers)
...
- [x] T191 [P] Verify all new tool responses include Protocol v1 metadata fields and all tool errors map to `openspec/meta/protocol-error-codes.md` with actionable `error.data` payload where applicable

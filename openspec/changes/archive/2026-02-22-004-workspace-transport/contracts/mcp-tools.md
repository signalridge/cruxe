...
Error codes MUST follow the canonical registry in `openspec/meta/protocol-error-codes.md`.
...
`error.code` values from `openspec/meta/protocol-error-codes.md` (it is only a wrapper,

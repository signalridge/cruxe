...
openspec/
  ...
  specs/
    001-core-mvp/                    # v0.1.0 (capability spec)
    002-agent-protocol/              # v0.2.0 (capability spec)
    003-structure-nav/               # v0.3.0-rc (capability spec)
    004-workspace-transport/         # v0.3.0 (capability spec)
    ...                              # + 17 additional capability specs

  changes/
    archive/
      2026-02-22-001-core-mvp/       # v0.1.0 (legacy phase, archived)
      2026-02-22-002-agent-protocol/ # v0.2.0
      2026-02-22-003-structure-nav/  # v0.3.0-rc
      2026-02-22-004-workspace-transport/ # v0.3.0
      2026-02-22-005-vcs-core/       # v0.9.0 (VCS correctness core)
      2026-02-22-006-vcs-ga-tooling/ # v1.0.0 (GA tooling completion)
      2026-02-22-007-call-graph/     # v1.1.0
      2026-02-22-008-semantic-hybrid/ # v1.2.0
      2026-02-22-009-distribution/   # v1.3.0
      ...                            # + 12 additional archived changes
    ...                              # + 8 active changes
```

## Design Principle

- **`openspec/meta/design.md`** is the single source of truth for architecture and design constraints.
- **`openspec/meta/*.md`** are cross-cutting operational and planning documents.
- **`openspec/specs/`** holds capability specs; **`openspec/changes/archive/`** holds legacy phase archives with original implementation artifacts.
...
|----|------|---------|-------|----------|--------|------------|--------|
| 001 | [Core MVP](../specs/001-core-mvp/) | v0.1.0 | 81 | C4 | implemented | -- | 002 |
| 002 | [Agent Protocol](../specs/002-agent-protocol/) | v0.2.0 | 63 | C4 | pending | 001 | 003 |
| 003 | [Structure & Navigation](../specs/003-structure-nav/) | v0.3.0-rc | 56 | C4 | pending | 002 | 004 |
| 004 | [Workspace & Transport](../specs/004-workspace-transport/) | v0.3.0 | 47 | C4 | pending | 003 | 005 |
| 005 | [VCS Core](../changes/archive/2026-02-22-005-vcs-core/) | v0.9.0 | 56 | C4 | pending | 004 | 006 |
| 006 | [VCS GA Tooling](../changes/archive/2026-02-22-006-vcs-ga-tooling/) | v1.0.0 | 29 | C4 | pending | 005 | 007 |
| 007 | [Call Graph](../changes/archive/2026-02-22-007-call-graph/) | v1.1.0 | 39 | C4 | pending | 006 | 008 |
| 008 | [Semantic/Hybrid](../changes/archive/2026-02-22-008-semantic-hybrid/) | v1.2.0 | 53 | C4 | pending | 007 | 009 |
| 009 | [Distribution](../changes/archive/2026-02-22-009-distribution/) | v1.3.0 | 39 | C4 | pending | 008 | -- |
...
- Legacy `plan/` documents have been migrated into `openspec/meta/` and are non-authoritative.

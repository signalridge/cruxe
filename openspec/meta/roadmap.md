...
|-------|---------|------|-----------------|------|
| 0+1 | v0.1.0 | [001-core-mvp](../specs/001-core-mvp/) | `init/index/search/locate` baseline | G1 |
| 1.1 | v0.2.0 | [002-agent-protocol](../specs/002-agent-protocol/) | `detail_level`, `get_file_outline`, health/prewarm | G2 |
| 1.5a | v0.3.0-rc | [003-structure-nav](../specs/003-structure-nav/) | hierarchy/related/context tools | G3 |
| 1.5b | v0.3.0 | [004-workspace-transport](../specs/004-workspace-transport/) | workspace routing + HTTP transport | G4 |
| 2a | v0.9.0 | [005-vcs-core](../changes/archive/2026-02-22-005-vcs-core/) | branch overlay correctness core | G5 |
| 2b | v1.0.0 | [006-vcs-ga-tooling](../changes/archive/2026-02-22-006-vcs-ga-tooling/) | diff/ref/ranking/ref-switch/export-import tooling | G6 (GA) |
| 2.5 | v1.1.0 | [007-call-graph](../changes/archive/2026-02-22-007-call-graph/) | `get_call_graph` + symbol comparison | G7 |
| 3 | v1.2.0 | [008-semantic-hybrid](../changes/archive/2026-02-22-008-semantic-hybrid/) | adaptive hybrid semantic + privacy-gated rerank | G8 |
| 4 | v1.3.0 | [009-distribution](../changes/archive/2026-02-22-009-distribution/) | cross-platform release and onboarding assets | G9 |
